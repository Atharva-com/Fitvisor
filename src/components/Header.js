            ...
            <div className='flex items-center justify-between py-6'>
                ...
                <div className='flex gap-x-2 items-center'>
                    ...
                    <div className='sm:relative sm:top-0 sm:left-0 absolute top-[7rem] left-[2rem]'>
                        {login ? <h1 className='text-white font-semibold text-xl font-mono '>Hello, there👋</h1> : <Link to='/login' type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Login</Link>}
